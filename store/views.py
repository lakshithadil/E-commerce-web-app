...
from .permitions import IsAdminOrReadOnly, ViewCustomerHistory
from .models import (
    Product,
    Collection,
    OrderItem,
...
class ProductViewSet(ModelViewSet):
    ...
    def destroy(self, request, *args, **kwargs):
        if OrderItem.objects.filter(product_id=kwargs["pk"]).count() > 0:
            return Response(
                {
                    "error": "Product can not be deleted because it is associated with otderitem"
                },
